...
export class BrandComponent implements OnInit {
  ...
  constructor(private repoService: RepositoryService, 
    ...
    private router: Router,private dialogserve: DialogService,
  ...
  public getAllBrands = () => {
    this.repoService.getData('api/brands')
      .subscribe(res => {
  ...
  DeleteRole(id: any) {
    this.dialogserve.openConfirmDialog('Are you sure, you want to delete the brand ?')
      .afterClosed()
      .subscribe(   (res) => {
        if (res) {
  ...
  const config: ModalOptions = {
          ...
          this.bsModalRef.content.redirectOnOk.subscribe((_: any) =>  this.getAllBrands());
          });
        }
      });
  }
